(ns tieminos.habitat.extended-sections.hacia-un-nuevo-universo.scratch.bp-delay
  (:require
...
(oe/defsynth bp-delay
  [in 0
   ...
   amp 1
   gate 1]
  (let [shifted (o/pitch-shift (o/in in 1) 0.1
                               ratio
                               0
                               0)
        delayed (-> (+ (o/in in 1) (* (lfo 0.1 0.5 1) shifted))
