(ns tieminos.7d-percussion-ensamble.explorations.original
  "Copy of tieminos.piraran.experiments.diatonic-scales
   Video on: https://www.youtube.com/watch?v=_0p0Cqw-fHY"
  (:require
