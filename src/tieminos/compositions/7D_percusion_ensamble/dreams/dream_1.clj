...
(comment
  ...
  (let [degs (fn [m]
               (case m
                 1 [0 2 0 [2 3 8 5] [7 4 3 4 2 1] [4 5] 3]
                 2 [[0 5 5]
                    2
                    [1 -7]
                    [8 2 8]
        ...
        sm1-amp [70 80 90 100]
        sm2-amp [70 80 60 40]
        mratio 1/17
        sm-weights {0.1 9 1 5 2 2}
        m-reset? false
        ...
        ;;
        sbass-space (fn [] 6)
        sm1-space (fn [] (weighted {6 9}))
        sm2-space (fn [] (weighted {6 2}))
        modu-space (fn [] (weighted {6 1, 8 0}))]
    (ref-rain
     :id ::1 :durs [3 2 2] :ratio 1/9
     :on-event (on-event
