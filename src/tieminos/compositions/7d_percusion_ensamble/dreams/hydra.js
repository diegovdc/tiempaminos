...
src(o1)
  ...
  .modulate(src(o2), cc(preOutMod))
  //.mult(solid(1, 0.5, 1))
    .saturate(cc(outSaturation))
   .mult(solid(), cc(blackFade))
//.mask(shape(360).scale(() => cc(blackFade)()*5))
  .out(o2)
...
src(o1)
  ...
  .add(src(o2)
      .scale(() => Math.sin(time * 0.7) * 0.1 + 1.1, () => Math.sin(time * 0.8) * 0.1 + 1.1), 0.1)
  .blend(src(o2), cc(inBlend))
  .modulate(voronoi()
      .saturate(1.2), () => cc(voronoiMod)() * 4)
  .add(src(o2)
  ...
  //.mult(solid(1, 0.5, 1))
    .saturate(cc(outSaturation))
   .mult(solid(), cc(blackFade))
//.brightness(0.04) // good for the ending
//.mask(shape(360).scale(() => cc(blackFade)()*5))
  .out(o2)
...
outSaturation = 88
heptDancerRepeat = 89
heptDancerScrollX = 90
heptDancerScrollY = 91
heptDancerAdd = 92
...
voronoi(2, 3, 10)
  ...
  .modulate(shape(7, 0.8)
      ...
      .modulateRotate(voronoi()), 6)
  	.add(shape(7)
  		.scale(() => Math.sin(time* (1/cc(heptDancerRepeat)())) * 0.9 + 0.3)
          .repeat(() => Math.ceil(cc(heptDancerRepeat)() * 8))
  		.scrollX(0, () =>  cc(heptDancerScrollX)() * 0.8 - 0.4)
  		.scrollY(0, () => cc(heptDancerScrollY)() * 0.8 - 0.4)
  		.modulateRotate(noise(1)), () => cc(heptDancerAdd)() * 10)
  // 	.add(shape(7)
  // 		.repeat([3, 1, 5, 10])
  // 		.mult(osc(1, 0.5, 0.9)
  // 			.kaleid())
