(ns erv-fib-synth.beats.two
  (:require
   [erv-fib-synth.midi :refer [note-on midi-event]]
   [erv-fib-synth.utils :refer [linexp]]
   [erv-fib-synth.synths :as synth]
   [erv-fib-synth.utils :as utils :refer [periods gen-chord]]
   [erv.cps.core :as cps]
   [erv.scale.core :as scale]
   [overtone.core :as o :refer :all :exclude [on-event scale]]
   [time-time.dynacan.players.gen-poly :as gp :refer [on-event ref-rain]]
   [time-time.standard :refer [wrap-at]]
   [erv-fib-synth.impros.session1]))
